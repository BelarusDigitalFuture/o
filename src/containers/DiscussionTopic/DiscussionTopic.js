      ...
      <>
            ...
            <div className="card">
              <div className="card-header">
                ...
                <button
                  className="delete"
                  aria-label="close"
                  onClick={this.onCommentsClickHandler}
                />
              </div>
        ...
        <div className="card">
          ...
          <div className="card-content">
            <div className="content">
              ...
              {this.state.expanded ? (
                ...
                <a href="#!" onClick={this.onReadMoreClickHandler}>
                  Read more
                </a>
              )}
            </div>
          ...
          <footer className="card-footer">
            <a href="#" className="card-footer-item" onClick={this.onCommentsClickHandler}>
              Комментарии ({this.props.comments.length})
            </a>
          </footer>
        </div>
        <br />
